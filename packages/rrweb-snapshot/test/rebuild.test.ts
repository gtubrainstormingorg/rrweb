...
ul li.specified c.\\:hover img {
  color: white
    ...
    it('can handle broken css', () => {
      const cssText = `:root { --example-var: { "Version": { "Build": "10.30.7.350828.20230224122352", "Source": "10.30.7.350828.1", "Required": "10.30.7.307232"; } } } @font-face { font-family: 'Calibri'; }`;
      expect(adaptCssForReplay(cssText, cache)).toMatchCss(
    ...
    it('can handle more broken css', () => {
      const cssText = `.sapThemeMetaData-UR-ls { background-image: url(\"https://cached-assets.howdygo.com/NWSRNMKs2gbuMpcwprO55nP9gp7Vfg3eqdiVRkwXXN8\"); }:root { --sapThemeMetaData-UR-ls: {\"Path\": \"UR.ls.sap_fiori_3.standards\", \"PathPattern\": \"/%frameworkId%/%libId%/%themeId%/%fileId%.css\", \"Extends\": [\"sap_base_fiori\",\"baseTheme\"], \"Tags\": [\"Fiori_3\",\"Touch\"], \"Scopes\": [\"lsCondensed\",\"lsScope--fioripaddings\"], \"Engine\": {\"Name\": \"theming-engine\", \"Version\": \"1.73.0\"}, \"Version\": { \"Build\": \"10.30.7.350828.20230224122352\", \"Source\": \"10.30.7.350828.1\", \"Required\": \"10.30.7.307232\"}}; } @font-face { font-family: SAP-icons; src: url(\"https://cached-assets.howdygo.com/FiD_UCYglUKNaic1GWjVsdo1vH1SoepXUAu-4DZCMYo\") format(\"woff2\"), url(\"https://cached-assets.howdygo.com/9CaG308voNtewYiojBH-MVsdeNxvJ_QHvKWJ2rAr3oo\") format(\"woff\"), url(\"https://cached-assets.howdygo.com/evz6RsLr0mp-dJ9EC8awnTEiFVKT8FFWXjxsqLhNoSc\") format(\"truetype\"), local(\"SAP-icons\"); font-weight: normal; font-style: normal; }`;
      expect(adaptCssForReplay(cssText, cache)).toMatchCss(
        `.sapThemeMetaData-UR-ls { background-image: url(\"https://cached-assets.howdygo.com/NWSRNMKs2gbuMpcwprO55nP9gp7Vfg3eqdiVRkwXXN8\"); }:root { --sapThemeMetaData-UR-ls: {\"Path\": \"UR.ls.sap_fiori_3.standards\", \"PathPattern\": \"/%frameworkId%/%libId%/%themeId%/%fileId%.css\", \"Extends\": [\"sap_base_fiori\",\"baseTheme\"], \"Tags\": [\"Fiori_3\",\"Touch\"], \"Scopes\": [\"lsCondensed\",\"lsScope--fioripaddings\"], \"Engine\": {\"Name\": \"theming-engine\", \"Version\": \"1.73.0\"}, \"Version\": { \"Build\": \"10.30.7.350828.20230224122352\", \"Source\": \"10.30.7.350828.1\", \"Required\": \"10.30.7.307232\"}}; } @font-face { font-family: SAP-icons; src: url(\"https://cached-assets.howdygo.com/FiD_UCYglUKNaic1GWjVsdo1vH1SoepXUAu-4DZCMYo\") format(\"woff2\"), url(\"https://cached-assets.howdygo.com/9CaG308voNtewYiojBH-MVsdeNxvJ_QHvKWJ2rAr3oo\") format(\"woff\"), url(\"https://cached-assets.howdygo.com/evz6RsLr0mp-dJ9EC8awnTEiFVKT8FFWXjxsqLhNoSc\") format(\"truetype\"), local(\"SAP-icons\"); font-weight: normal; font-style: normal; }`,
      );
    });
